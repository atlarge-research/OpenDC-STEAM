...
def generate_topology(workload: str, NoH: int, battery_capacity: float, carbon_trace: str, 
                           starting_CI: float, charging_speed: int = 1000, embodied_carbon_cost: int = 100):
    data = {
        "clusters":
        [
            {
                "name": "C01",
                "hosts" : generate_hosts(workload, NoH),
                "powerSource": {
