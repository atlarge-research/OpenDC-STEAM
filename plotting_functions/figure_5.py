...
df_base_surf = pd.read_csv(f"{base_folder}/results/surf/results.csv")
...
df_base_marconi = pd.read_csv(f"{base_folder}/results/marconi/results.csv")
...
df_base_borg = pd.read_csv(f"{base_folder}/results/borg/results.csv")
